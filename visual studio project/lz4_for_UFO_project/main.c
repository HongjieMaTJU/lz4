...
int main(void) {
    ...
    const char* const src = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscing elit.";
    ...
    if (compressed_data_size > 0)
        printf("We successfully compressed some data! Ratio: %.2f,src_size = %d,compressed data size = %d\n",
            (float) src_size/ compressed_data_size, src_size, compressed_data_size);
